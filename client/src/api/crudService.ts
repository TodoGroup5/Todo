...
import { isProductionEnvironment } from "../utility/deployment";

export class CrudService {
	private static readonly baseUrl = isProductionEnvironment() ? "https://ec2-16-28-24-187.af-south-1.compute.amazonaws.com/api"
