...
export class CrudService {
	...
	private static async makeRequest<S>(url: string, method: string, body?: RequestInit["body"], options?: CrudOptions): Promise<ApiResponse<S>> {
		try {
	...
	static create<T extends RequestInit["body"], R>(endpoint: string, data: T, options?: CrudOptions): Promise<ApiResponse<R>> {
	...
	static update<T extends RequestInit["body"], R>(endpoint: string, id: string | number, data: T, options?: CrudOptions): Promise<ApiResponse<R>> {
	...
	static customRequest<R>(endpoint: string, method: string, body?: RequestInit["body"], options?: CrudOptions): Promise<ApiResponse<R>> {
