...
export class CrudService {
	private static readonly baseUrl = "https://ec2-16-28-24-187.af-south-1.compute.amazonaws.com/api";
	...
	static patch<T, R = T>(
		...
		return this.makeRequest<R>(`${endpoint}/${id}`, "PATCH", data, options);
	}
	...
	static customRequest<T>(
		...
		return this.makeRequest<T>(endpoint, method, body, options);
	}
